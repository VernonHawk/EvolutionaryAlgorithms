...
export const F24_Generalized_Shubert_dim_2: TestFunctionSpec = {
  ...
  absolutePeaks: [
    ...
    global: true,
    ...makePeak(individualToPopulationEntry(F24_Generalized_Shubert_Base.fun)(makeIndividual(p))),
  })),
  peaks: [],
  dimensions: 2,
}
...
export const F42_5_hills_4_valleys: TestFunctionSpec = {
  ...
  absolutePeaks: [
    ...
    ...makePeak(individualToPopulationEntry(F42_5_hills_4_valleys_fun)(makeIndividual(peak))),
  })),
  wide: false,
  dimensions: 2,
}
